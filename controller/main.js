function onload(lang) {
    ...
    xhttp.onload = function() {
        ...
        change_dom("content__home--subsection-buttom1",ourData[3].details);
        ...
        change_dom("content__home--subsection-buttom2",ourData[4].details);
        ...
        change_dom("content__home--subsection-buttom3",ourData[5].details);
        ...
        change_dom("content__home--subsection-buttom4",ourData[6].details);
